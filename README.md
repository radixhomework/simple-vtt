...
**Simple VTT** is a simple, lightweight, self-hosted virtual tabletop
...
- [Architecture notes](docs/ARCHITECTURE.md) — code layout, builds, rendering pipeline, tile pyramids, data flow
